...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostCreate', function() {
      beforeEach(function() {
        instance = new JbsBackendService.PostCreate();
      });

      it('should create an instance of PostCreate', function() {
        // TODO: update the code to test PostCreate
        expect(instance).to.be.a(JbsBackendService.PostCreate);
      });
