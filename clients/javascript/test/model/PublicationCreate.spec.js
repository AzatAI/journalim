...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PublicationCreate', function() {
      beforeEach(function() {
        instance = new JbsBackendService.PublicationCreate();
      });

      it('should create an instance of PublicationCreate', function() {
        // TODO: update the code to test PublicationCreate
        expect(instance).to.be.a(JbsBackendService.PublicationCreate);
      });
