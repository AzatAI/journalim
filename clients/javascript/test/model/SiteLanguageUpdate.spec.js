...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SiteLanguageUpdate', function() {
      beforeEach(function() {
        instance = new JbsBackendService.SiteLanguageUpdate();
      });

      it('should create an instance of SiteLanguageUpdate', function() {
        // TODO: update the code to test SiteLanguageUpdate
        expect(instance).to.be.a(JbsBackendService.SiteLanguageUpdate);
      });
