...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostLanguageRead', function() {
      beforeEach(function() {
        instance = new JbsBackendService.PostLanguageRead();
      });

      it('should create an instance of PostLanguageRead', function() {
        // TODO: update the code to test PostLanguageRead
        expect(instance).to.be.a(JbsBackendService.PostLanguageRead);
      });
