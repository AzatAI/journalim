...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ErrorResponseModel', function() {
      beforeEach(function() {
        instance = new JbsBackendService.ErrorResponseModel();
      });

      it('should create an instance of ErrorResponseModel', function() {
        // TODO: update the code to test ErrorResponseModel
        expect(instance).to.be.a(JbsBackendService.ErrorResponseModel);
      });
