...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostLanguageCreate', function() {
      beforeEach(function() {
        instance = new JbsBackendService.PostLanguageCreate();
      });

      it('should create an instance of PostLanguageCreate', function() {
        // TODO: update the code to test PostLanguageCreate
        expect(instance).to.be.a(JbsBackendService.PostLanguageCreate);
      });
      ...
      it('should have the property postId (base name: "post_id")', function() {
        // TODO: update the code to test the property postId
        expect(instance).to.have.property('postId');
        // expect(instance.postId).to.be(expectedValueLiteral);
      });
