...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IssueUpdate', function() {
      beforeEach(function() {
        instance = new JbsBackendService.IssueUpdate();
      });

      it('should create an instance of IssueUpdate', function() {
        // TODO: update the code to test IssueUpdate
        expect(instance).to.be.a(JbsBackendService.IssueUpdate);
      });
