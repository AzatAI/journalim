...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IssueRead', function() {
      beforeEach(function() {
        instance = new JbsBackendService.IssueRead();
      });

      it('should create an instance of IssueRead', function() {
        // TODO: update the code to test IssueRead
        expect(instance).to.be.a(JbsBackendService.IssueRead);
      });
