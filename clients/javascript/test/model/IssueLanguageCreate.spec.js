...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IssueLanguageCreate', function() {
      beforeEach(function() {
        instance = new JbsBackendService.IssueLanguageCreate();
      });

      it('should create an instance of IssueLanguageCreate', function() {
        // TODO: update the code to test IssueLanguageCreate
        expect(instance).to.be.a(JbsBackendService.IssueLanguageCreate);
      });
