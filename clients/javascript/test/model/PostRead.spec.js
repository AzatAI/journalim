...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostRead', function() {
      beforeEach(function() {
        instance = new JbsBackendService.PostRead();
      });

      it('should create an instance of PostRead', function() {
        // TODO: update the code to test PostRead
        expect(instance).to.be.a(JbsBackendService.PostRead);
      });
