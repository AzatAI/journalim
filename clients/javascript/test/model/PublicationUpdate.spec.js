...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PublicationUpdate', function() {
      beforeEach(function() {
        instance = new JbsBackendService.PublicationUpdate();
      });

      it('should create an instance of PublicationUpdate', function() {
        // TODO: update the code to test PublicationUpdate
        expect(instance).to.be.a(JbsBackendService.PublicationUpdate);
      });
