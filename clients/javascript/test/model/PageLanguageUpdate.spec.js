...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageLanguageUpdate', function() {
      beforeEach(function() {
        instance = new JbsBackendService.PageLanguageUpdate();
      });

      it('should create an instance of PageLanguageUpdate', function() {
        // TODO: update the code to test PageLanguageUpdate
        expect(instance).to.be.a(JbsBackendService.PageLanguageUpdate);
      });
