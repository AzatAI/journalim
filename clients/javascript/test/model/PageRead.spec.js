...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageRead', function() {
      beforeEach(function() {
        instance = new JbsBackendService.PageRead();
      });

      it('should create an instance of PageRead', function() {
        // TODO: update the code to test PageRead
        expect(instance).to.be.a(JbsBackendService.PageRead);
      });
