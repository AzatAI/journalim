...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageCreate', function() {
      beforeEach(function() {
        instance = new JbsBackendService.PageCreate();
      });

      it('should create an instance of PageCreate', function() {
        // TODO: update the code to test PageCreate
        expect(instance).to.be.a(JbsBackendService.PageCreate);
      });
