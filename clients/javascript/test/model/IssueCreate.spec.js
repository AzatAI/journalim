...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IssueCreate', function() {
      beforeEach(function() {
        instance = new JbsBackendService.IssueCreate();
      });

      it('should create an instance of IssueCreate', function() {
        // TODO: update the code to test IssueCreate
        expect(instance).to.be.a(JbsBackendService.IssueCreate);
      });
