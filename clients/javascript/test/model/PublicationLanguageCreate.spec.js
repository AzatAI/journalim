...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PublicationLanguageCreate', function() {
      beforeEach(function() {
        instance = new JbsBackendService.PublicationLanguageCreate();
      });

      it('should create an instance of PublicationLanguageCreate', function() {
        // TODO: update the code to test PublicationLanguageCreate
        expect(instance).to.be.a(JbsBackendService.PublicationLanguageCreate);
      });
      ...
      it('should have the property publicationId (base name: "publication_id")', function() {
        // TODO: update the code to test the property publicationId
        expect(instance).to.have.property('publicationId');
        // expect(instance.publicationId).to.be(expectedValueLiteral);
      });
