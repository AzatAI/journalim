...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PublicationLanguageUpdate', function() {
      beforeEach(function() {
        instance = new JbsBackendService.PublicationLanguageUpdate();
      });

      it('should create an instance of PublicationLanguageUpdate', function() {
        // TODO: update the code to test PublicationLanguageUpdate
        expect(instance).to.be.a(JbsBackendService.PublicationLanguageUpdate);
      });
