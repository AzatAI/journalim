...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageUpdate', function() {
      beforeEach(function() {
        instance = new JbsBackendService.PageUpdate();
      });

      it('should create an instance of PageUpdate', function() {
        // TODO: update the code to test PageUpdate
        expect(instance).to.be.a(JbsBackendService.PageUpdate);
      });
