...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PublicationLanguageRead', function() {
      beforeEach(function() {
        instance = new JbsBackendService.PublicationLanguageRead();
      });

      it('should create an instance of PublicationLanguageRead', function() {
        // TODO: update the code to test PublicationLanguageRead
        expect(instance).to.be.a(JbsBackendService.PublicationLanguageRead);
      });
