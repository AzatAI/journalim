...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageLanguageCreate', function() {
      beforeEach(function() {
        instance = new JbsBackendService.PageLanguageCreate();
      });

      it('should create an instance of PageLanguageCreate', function() {
        // TODO: update the code to test PageLanguageCreate
        expect(instance).to.be.a(JbsBackendService.PageLanguageCreate);
      });
